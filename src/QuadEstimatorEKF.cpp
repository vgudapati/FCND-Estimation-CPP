...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro)
{
  ...
  Quaternion<float> q_gyro = Quaternion<float>::FromEuler123_RPY(rollEst, pitchEst, ekfState(6));
  q_gyro.IntegrateBodyRate(gyro, dtIMU);
  V3D eulerRPY = q_gyro.ToEulerRPY();
...
MatrixXf QuadEstimatorEKF::GetRbgPrime(float roll, float pitch, float yaw)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  // From equation 52 in the estimation for Quadrotors
